...
class MyTranslations extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        "ar": {
          ...
          // ---------- HomeManager ----------
          "managerDashboardGreeting": "مرحبا",
          "managerDashboardTitle": "طاب مساك أيها المدير!",
          "managerDashboardStatsSection": "قسم الإحصائيات",
          "managerDashboardStatsSection2": "مبيعات الشهر المحدد",
          "managerDashboardSeason": "موسم",
          "managerDashboardTotalOrders": "إجمالي عدد الطلبات\n في الشهر المحدد",
          "managerDashboardTotalSales": "إجمالي مبيعات الشهر\nالمحدد",
          "managerDashboardNewOrders": "الطلبات الجديدة",
          "managerDashboardLatest": "حديث",
          "managerDashboardMostRequested": "المنتجات الأكثر طلباً",
          "managerDashboardMostPopular": "الأكثر شهرة",


          // ---------- product ----------
          "productAndServiceManagement": "إدارة المنتجات والخدمات",
          "addedItemsProducts": "منتجاتك المضافة",
          "addedItemsServices": "خدماتك المضافة",
          "addedItemsSubtitle": "منتجاتي المضافة والتصنيفات المخصصة",
          "addedItemsEditProduct": "تعديل تفاصيل المنتج",
          "addedCatMaintenance": "معدات الصيانة",
          "addedCatFootball": "معدات كرة القدم",
          "addCategoryTitle": "إضافة تصنيف جديد",
          "addCategoryNameLabel": "اسم التصنيف",
          "addCategoryNameHint": "اكتب اسم التصنيف الجديد",
          "addCategoryConfirm": "تأكيد إضافة التصنيف",
          "addProductTitle": "إضافة منتج جديد",
          "addProductNameLabel": "اسم المنتج",
          "addProductNameHint": "اكتب اسم المنتج",
          "addProductCategoryLabel": "تصنيف المنتج",
          "addProductCategoryHint": "اختر تصنيف المنتج",
          "addProductSpecsLabel": "مواصفات المنتج",
          "addProductSpecsHint": "اكتب مواصفات المنتج",
          "addProductPriceLabel": "حدد سعر المنتج",
          "addProductPriceHint": "حدد السعر الخاص بالمنتج",
          "addProductImageLabel": "صورة توضيحية للمنتج",
          "addProductImageHint": "انقر لاختيار صورة للمنتج",
          "addProductConfirm": "تأكيد إضافة المنتج",
          "sampleTagSoft": "ملمس ناعم",
          "sampleTagStrong": "متانة عالية",


          "allNewRequests": "كافة الطلبات الجديدة",
          "orderManagement": "إدارة الطلبات",
          "orderNewOrders": "الطلبات الجديدة",
          "orderPreOrders": "الطلبات المسبقة",
          "orderOtherOrders": "طلبات أخرى",
          "orderMore": "المزيد",
          "orderStatusDelivered": "تم التسليم",
          "orderStatusShipping": "قيد الإرسال",
          "orderBadgeNew": "حديث",
          "orderCurrency": "ريال",
          "orderBallsCount": ":count كرات",

          "proFootball": "كرات قدم احترافية",
          "proBasketball": "كرات سلة احترافية",
        },
        ...
        "en": {
          ...
          // ---------- HomeManager ----------
          "managerDashboardGreeting": "Hello",
          "managerDashboardTitle": "Good evening, Manager!",
          "managerDashboardStatsSection": "Statistics",
          "managerDashboardStatsSection2": "Sales for the specified month",
          "managerDashboardSeason": "Season",
          "managerDashboardTotalOrders": "Total orders in the selected month",
          "managerDashboardTotalSales": "Total monthly sales",
          "managerDashboardNewOrders": "New orders",
          "managerDashboardLatest": "Latest",
          "managerDashboardMostRequested": "Most requested products",
          "managerDashboardMostPopular": "Most popular",

          // ---------- product ----------
          "productAndServiceManagement": "Product and Service Management",
          "addedItemsProducts": "Your added products",
          "addedItemsServices": "Your added services",
          "addedItemsSubtitle": "My added products and custom categories",
          "addedItemsEditProduct": "Edit product details",
          "addedCatMaintenance": "Maintenance equipment",
          "addedCatFootball": "Football equipment",
          "addCategoryTitle": "Add New Category",
          "addCategoryNameLabel": "Category Name",
          "addCategoryNameHint": "Enter the new category name",
          "addCategoryConfirm": "Confirm Category",
          "addProductTitle": "Add New Product",
          "addProductNameLabel": "Product Name",
          "addProductNameHint": "Enter product name",
          "addProductCategoryLabel": "Product Category",
          "addProductCategoryHint": "Choose product category",
          "addProductSpecsLabel": "Product Specifications",
          "addProductSpecsHint": "Enter product specifications",
          "addProductPriceLabel": "Set Product Price",
          "addProductPriceHint": "Enter product price",
          "addProductImageLabel": "Product Image",
          "addProductImageHint": "Tap to choose an image",
          "addProductConfirm": "Confirm Add Product",
          "sampleTagSoft": "Soft touch",
          "sampleTagStrong": "High durability",

          "allNewRequests": "All new requests",
          "orderManagement": "Order Management",
          "orderNewOrders": "New orders",
          "orderPreOrders": "Pre-orders",
          ...
          "orderBadgeNew": "New",
          "orderCurrency": "SAR",
          "orderBallsCount": ":count balls",

          "proFootball": "Pro footballs",
          "proBasketball": "Pro basketballs",
        }
      };
}
